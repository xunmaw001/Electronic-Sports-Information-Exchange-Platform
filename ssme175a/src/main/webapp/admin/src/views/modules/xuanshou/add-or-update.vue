  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="名称" prop="mingcheng">
              <el-input v-model="ruleForm.mingcheng" 
                placeholder="名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="所属战队" prop="suoshuzhandui">
          <el-input v-model="ruleForm.suoshuzhandui" 
              placeholder="所属战队" clearable  :readonly="ro.suoshuzhandui"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="所属战队" prop="suoshuzhandui">
              <el-input v-model="ruleForm.suoshuzhandui" 
                placeholder="所属战队" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.zhaopian" label="照片" prop="zhaopian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.zhaopian.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="当前段位" prop="dangqianduanwei">
          <el-select v-model="ruleForm.dangqianduanwei" placeholder="请选择当前段位">
            <el-option
                v-for="(item,index) in dangqianduanweiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="当前段位" prop="dangqianduanwei">
	      <el-input v-model="ruleForm.dangqianduanwei"
                placeholder="当前段位" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="当前分数" prop="dangqianfenshu">
          <el-input v-model="ruleForm.dangqianfenshu" 
              placeholder="当前分数" clearable  :readonly="ro.dangqianfenshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="当前分数" prop="dangqianfenshu">
              <el-input v-model="ruleForm.dangqianfenshu" 
                placeholder="当前分数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                                                                                                      </el-row>
                                                                                                                                                                                                                                  <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="近期比赛记录" prop="jinqibisaijilu">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.jinqibisaijilu" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jinqibisaijilu" label="近期比赛记录" prop="jinqibisaijilu">
                    <span v-html="ruleForm.jinqibisaijilu"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	suoshuzhandui : false,
	zhaopian : false,
	dangqianduanwei : false,
	dangqianfenshu : false,
	jinqibisaijilu : false,
	xiangqing : false,
	thumbsupnum : false,
	crazilynum : false,
      },
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.mingcheng = true;
            continue;
	            	            ...
	            	            if(o=='suoshuzhandui'){
            this.ruleForm.suoshuzhandui = obj[o];
	    this.ro.suoshuzhandui = true;
            continue;
          }
	            	            if(o=='zhaopian'){
	    ...
	    this.ro.zhaopian = true;
            continue;
	            	            ...
	            	            if(o=='dangqianduanwei'){
            this.ruleForm.dangqianduanwei = obj[o];
	    this.ro.dangqianduanwei = true;
            continue;
          }
	            	            if(o=='dangqianfenshu'){
            this.ruleForm.dangqianfenshu = obj[o];
	    this.ro.dangqianfenshu = true;
            continue;
          }
	            	            if(o=='jinqibisaijilu'){
            this.ruleForm.jinqibisaijilu = obj[o];
	    this.ro.jinqibisaijilu = true;
            continue;
          }
	            	            if(o=='xiangqing'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                                                ...
                                                                                                this.dangqianduanweiOptions = "黑铁,青铜,白银,黄金,铂金,钻石,超凡大师,傲世宗师,最强王者".split(',')
                                                                                                                      },
                                                                                // 多级联动参数
                                                                                                      info(id) {
      this.$http({
        url: `xuanshou/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
	...
	this.ruleForm.jinqibisaijilu = this.ruleForm.jinqibisaijilu.replace(reg,'../../../ssme175a/upload');
	this.ruleForm.xiangqing = this.ruleForm.xiangqing.replace(reg,'../../../ssme175a/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `xuanshou/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xuanshouCrossAddOrUpdateFlag = false;
                  this.parent.search();
