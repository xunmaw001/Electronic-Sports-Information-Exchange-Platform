<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="英雄名称" prop="yingxiongmingcheng">
          <el-input v-model="ruleForm.yingxiongmingcheng" 
              placeholder="英雄名称" clearable  :readonly="ro.yingxiongmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="英雄名称" prop="yingxiongmingcheng">
              <el-input v-model="ruleForm.yingxiongmingcheng" 
                placeholder="英雄名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="真名" prop="zhenming">
          <el-input v-model="ruleForm.zhenming" 
              placeholder="真名" clearable  :readonly="ro.zhenming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="真名" prop="zhenming">
              <el-input v-model="ruleForm.zhenming" 
                placeholder="真名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="类型" prop="leixing">
              <el-input v-model="ruleForm.leixing" 
                placeholder="类型" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="照片" prop="zhaopian">
          <el-input v-model="ruleForm.zhaopian" 
              placeholder="照片" clearable  :readonly="ro.zhaopian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="照片" prop="zhaopian">
              <el-input v-model="ruleForm.zhaopian" 
                placeholder="照片" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                                                                                                                                    </el-row>
                                                                                              <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="背景介绍" prop="beijingjieshao">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="背景介绍"
                  v-model="ruleForm.beijingjieshao" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.beijingjieshao" label="背景介绍" prop="beijingjieshao">
                    <span>{{ruleForm.beijingjieshao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="英雄技巧" prop="yingxiongjiqiao">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="英雄技巧"
                  v-model="ruleForm.yingxiongjiqiao" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.yingxiongjiqiao" label="英雄技巧" prop="yingxiongjiqiao">
                    <span>{{ruleForm.yingxiongjiqiao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
                                                                                                                          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="技能介绍" prop="jinengjieshao">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.jinengjieshao" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jinengjieshao" label="技能介绍" prop="jinengjieshao">
                    <span v-html="ruleForm.jinengjieshao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
      ro:{
	yingxiongmingcheng : false,
	zhenming : false,
	leixing : false,
	zhaopian : false,
	jinengjieshao : false,
	beijingjieshao : false,
	yingxiongjiqiao : false,
	thumbsupnum : false,
	crazilynum : false,
      },
            ruleForm: {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='yingxiongmingcheng'){
            this.ruleForm.yingxiongmingcheng = obj[o];
	    this.ro.yingxiongmingcheng = true;
            continue;
          }
	            	            if(o=='zhenming'){
            this.ruleForm.zhenming = obj[o];
	    this.ro.zhenming = true;
            continue;
          }
	            	            if(o=='leixing'){
	    ...
	    this.ro.zhaopian = true;
            continue;
	            	            ...
	            	            if(o=='jinengjieshao'){
            this.ruleForm.jinengjieshao = obj[o];
	    this.ro.jinengjieshao = true;
            continue;
          }
	            	            if(o=='beijingjieshao'){
            this.ruleForm.beijingjieshao = obj[o];
	    this.ro.beijingjieshao = true;
            continue;
          }
	            	            if(o=='yingxiongjiqiao'){
            this.ruleForm.yingxiongjiqiao = obj[o];
	    this.ro.yingxiongjiqiao = true;
            continue;
          }
	            	            if(o=='thumbsupnum'){
	...
	this.ruleForm.jinengjieshao = this.ruleForm.jinengjieshao.replace(reg,'../../../ssme175a/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `yingxiong/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yingxiongCrossAddOrUpdateFlag = false;
                  this.parent.search();
